...
4. Sem fluxo ativo: não enviar texto inventado; logar e sair. Default: fluxo ativo `id === "inicio"`, senão nome `"Atendimento Inicial"`, senão o primeiro ativo (`specs/02-domain.md`).
