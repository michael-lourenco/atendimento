...
export const EXPECTED_SCHEMA_COLUMNS: SchemaHealthIssue[] = [
  ...
  { table: 'conversations', column: 'viewer_agent_id', sqlType: 'text' },
  { table: 'conversations', column: 'viewer_agent_name', sqlType: 'text' },
  { table: 'conversations', column: 'viewer_at', sqlType: 'timestamptz' },
