...
Fases 1–5 feitas. Inbox: citação, digitando, PTT, visto no WhatsApp ao abrir a thread, busca por texto nas conversas, áudio nas respostas rápidas, SLA nos relatórios, aviso de schema para admin.
